        ...
        <div className="flex justify-between items-center relative">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 font-medium">Manage your forecasting jobs and projects</p>
            </div>
          </div>
            ...
            <div className="flex bg-white rounded-xl p-1.5 shadow-lg border border-gray-200">
              ...
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M3 6h18m-9 8h9m-9 4h9m-18-8V7a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1z" />
                </svg>
        ...
        <div className="bg-gradient-to-br from-white to-emerald-50 p-6 rounded-xl shadow-lg border border-emerald-100 hover:shadow-xl transition-all duration-300 group">
          <div className="flex items-center mb-4">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-emerald-800 bg-clip-text text-transparent">{formatCurrency(kpis.revenue.total)}</p>
            </div>
          </div>
          <div className="space-y-2">
            <div className="flex justify-between items-center px-3 py-2 bg-white/60 rounded-lg">
              <span className="text-sm text-gray-600 font-medium">Backlog:</span>
              <span className="text-sm font-bold text-emerald-700">{formatCurrency(kpis.revenue.backlog)}</span>
            </div>
            <div className="flex justify-between items-center px-3 py-2 bg-white/60 rounded-lg">
              <span className="text-sm text-gray-600 font-medium">SWAG:</span>
              <span className="text-sm font-bold text-blue-700">{formatCurrency(kpis.revenue.swag)}</span>
            </div>
          </div>
        </div>
        
        {/* Total Cost */}
        <div className="bg-gradient-to-br from-white to-rose-50 p-6 rounded-xl shadow-lg border border-rose-100 hover:shadow-xl transition-all duration-300 group">
          <div className="flex items-center mb-4">
            <div className="p-3 bg-gradient-to-br from-rose-400 to-rose-600 rounded-xl shadow-md group-hover:scale-110 transition-transform duration-300">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold bg-gradient-to-r from-rose-600 to-rose-800 bg-clip-text text-transparent">{formatCurrency(kpis.cost.total)}</p>
            </div>
          </div>
          <div className="space-y-2">
            <div className="flex justify-between items-center px-3 py-2 bg-white/60 rounded-lg">
              <span className="text-sm text-gray-600 font-medium">Backlog:</span>
              <span className="text-sm font-bold text-rose-700">{formatCurrency(kpis.cost.backlog)}</span>
            </div>
            <div className="flex justify-between items-center px-3 py-2 bg-white/60 rounded-lg">
              <span className="text-sm text-gray-600 font-medium">SWAG:</span>
              <span className="text-sm font-bold text-blue-700">{formatCurrency(kpis.cost.swag)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-white to-violet-50 p-6 rounded-xl shadow-lg border border-violet-100 hover:shadow-xl transition-all duration-300 group">
          <div className="flex items-center mb-4">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold bg-gradient-to-r from-violet-600 to-violet-800 bg-clip-text text-transparent">{formatCurrency(kpis.earnings.total)}</p>
            </div>
          </div>
          <div className="space-y-2">
            <div className="flex justify-between items-center px-3 py-2 bg-white/60 rounded-lg">
              <span className="text-sm text-gray-600 font-medium">Backlog:</span>
              <span className="text-sm font-bold text-violet-700">{formatCurrency(kpis.earnings.backlog)}</span>
            </div>
            <div className="flex justify-between items-center px-3 py-2 bg-white/60 rounded-lg">
              <span className="text-sm text-gray-600 font-medium">SWAG:</span>
              <span className="text-sm font-bold text-blue-700">{formatCurrency(kpis.earnings.swag)}</span>
            </div>
          </div>
        </div>
      </div>
